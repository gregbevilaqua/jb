...
if (isset($_GET['page']) && $_GET['page'] == 'Transaction') {
            ...
            $page = "consulta5";  
        } else if (isset($_GET['page']) && $_GET['page'] == 'delgerente') {
            $page = "delgerente";  
        } else if (isset($_GET['page']) && $_GET['page'] == 'listagerente') {
            $page = "listagerente";  
            ...
            $page = "consulta7";  
        } else if (isset($_GET['page']) && $_GET['page'] == 'limite') {
            $page = "limite";  
        } else if (isset($_GET['page']) && $_GET['page'] == 'delgere') {
            $page = "delgere";  
        } else if (isset($_GET['page']) && $_GET['page'] == 'gerencia') {
            $page = "gerencia";  
            ...
            $page = "deluser";  
        } else if (isset($_GET['page']) && $_GET['page'] == 'listaregi') {
            $page = "listaregi";  
        } else if (isset($_GET['page']) && $_GET['page'] == 'delregi') {
            $page = "delregi";  
