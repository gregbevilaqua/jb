...
$query = mysql_query("SELECT * FROM acerto WHERE data >='$data' AND data <= '$dataf' ORDER BY data ASC");
?>
<!DOCTYPE HTML>
<html>
...
$query = "SELECT * FROM acerto WHERE operador ='".$operador."' AND data >='$data' AND data <= '$dataf'  ORDER BY data DESC";
...
?>
    ...
    <?php
require_once("includes/db2.php");
$query2 = "SELECT comissao as COMI FROM tablet WHERE idprod='".$operador."' ";
$result2 = mysql_query($query2) or die(mysql_error());
$query_valor = "SELECT SUM(saldo)as SOMA, SUM(entcrs)as SOMA1, SUM(jackrs)as SOMA2  FROM acerto WHERE operador ='".$operador."' AND data >='$data' AND data <= '$dataf' ORDER BY data DESC";
        ...
        <table class="table table-bordered table-hover table-striped" id="tabela2"> 
            <thead>
                <tr>
                    ...
                    <th>Saldo Total a Receber</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td><?php echo "<h3>R$: ".number_format($entrad, 2, '.', ',')."</h3>";?></td>
                    <td><?php echo "<h3>R$: ".number_format($said, 2, '.', ',')."</h3>";?></td>
