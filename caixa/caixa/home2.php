...
include ('../includes/global.php');
	...
	$gerente = isset($_SESSION['gerente']) ? $_SESSION['gerente']: "";	
$query = "SELECT * FROM cambista WHERE gerente = '$gerente'";
...
echo "<h1>Seja bem vindo,".$teste."</h1>";
echo "<h3>Cambistas Cadastrados:</h3>";
                    echo "<h3>Gerente: ".$teste."</h3>";?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
...
<body>
 ...
 <div class="table-responsive">
        ...
        <tbody>
<?
$result = mysql_query("SELECT * FROM cambista WHERE gerente = '$teste'");
while($row = mysql_fetch_array($result)) {
    	echo "<tr>
        <td>".$row[2]."</td>
        <td>".$row[1]."</td>
        <td><a href='consulta.php?operador=".$row[2]."'><img src='../images/entrar.png'></a></td>
        <td><a href='../index.php><img src='../images/entrar.png'></a></td>
        </tr>";
