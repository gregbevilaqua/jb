...
<body>
 ...
 <div class="table-responsive">
        ...
        <tbody>
<?
$result = mysql_query("SELECT * FROM cambista WHERE gerente = '".$gerente."'");
while($row = mysql_fetch_array($result)) {
    	echo "<tr>
        <td>".$row[2]."</td>
        <td>".$row[1]."</td>
       <td><a href='index.php?page=consulta&operador=".$row[2]."&gerente=".$gerente."'><img src='images/entrar.png'></a></td>
        <td><a href='index.php?page=consulta2&operador=".$row[2]."&gerente=".$gerente."'><img src='images/entrar.png'></a></td>
        </tr>";
