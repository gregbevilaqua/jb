...
if ($limite2 > $limite3)
{
echo "<h3>Cadastro Gerente</h3>";
echo "<table border = '0'>";
echo "<form name='newuser' action='newgerente.php' onsubmit='return val()'>";
echo "<tr><td>Gerente</td><td><input type='text' name='gerente' id='gerente' autocomplete='off'></td></tr>";
echo "<tr><td>Senha:</td><td><input type='password' name='senhagerente' id='senhagerente' autocomplete='off'></td></tr>";
