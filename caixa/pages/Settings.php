...
// Get User Info
$GetUsers2	 	 = "SELECT valor from licenca";
$GetUserq2		 = mysqli_query($mysqli, $GetUsers2);
$UserInfos2      = mysqli_fetch_assoc($GetUserq2);
                    ...
                    <div class="panel panel-green">
                        ...
                        <form method="post" action="" role="form">
                            <fieldset>
                                ...
                                <div class="form-group col-lg-6">
                                    <label for="email"><?php echo "Nome do Administrador"; ?></label>
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input class="form-control"  required placeholder="<?php echo $LastNames; ?>" name="lastname"  value="<?php echo $UserInfos['LastName'];?>" type="text" >
                                     ...
                                     <div class="form-group col-lg-6">
                                    <label for="email"><?php echo "Limite Operador"; ?></label>
                                    <input class="form-control"  required placeholder="<?php echo "Limite Operador"; ?>" name="limite"  value="<?php echo $UserInfos2['valor'];?>" type="text" >
                                </div>
                                <div class="form-group col-lg-6">
