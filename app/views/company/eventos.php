...
<div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-suitcase fa-fw"></i> Adicionar novo Evento 
                        </div>
                        <!-- /.panel-heading -->
                    ...
                    <div class="form-group">
						...
						<input class="text-input form-control" name="name" type="text"  placeholder="Nome do Evento (obrigatório)" value="<? echo common::get_back_value("name") ; ?>" /> 
