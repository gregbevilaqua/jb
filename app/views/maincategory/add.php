                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <? foreach($data as $d){ ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                             <a href="<?=common::get_component_link(array('maincategory','edit')).'&id='.$d['id']; ?>" class="btn btn-sm" title="Editar"><i class="glyphicon glyphicon-pencil"></i></a>
										 <a href="<?=common::get_component_link(array('maincategory','delete')).'&id='.$d['id']; ?>" class="btn btn-sm"  title="Apagar"><i class="glyphicon glyphicon-remove"></i></a> 
