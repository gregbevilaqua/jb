...
<div class="row">
<div class="col-lg-12">
<h1 class="page-header"><i class="fa fa-user fa-fw"></i> Adicionar Usuário</h1>
</div>
</div>
<div class="row">
    <div class="col-md-6">
...
<div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-user fa-fw"></i> Adicionar usuário
                        </div>
                        <!-- /.panel-heading -->
			...
			<form id="form" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Nome de usuário</label>
                        <div class="col-lg-8">
						<input class="form-control" name="username" type="text" />
					   </div>
                    </div>
                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Senha</label>
                        <div class="col-lg-8">
                    ...
                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Ativo</label>
                        <div class="col-lg-8">
                    ...
                    <div class="form-group">
                        <div class="col-lg-8">
						<input class="btn" type="submit" name="submit" value="Adicionar" />
					       </div>
                    </div>
                    </div>
            </form>
...
<div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-user fa-fw"></i> Lista de usuários
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <? foreach($data as $d){ ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                             <a href="<?=common::get_component_link(array('user','edit')).'&id='.$d['id']; ?>" class=""  title="Editar"  style="float: left; padding: 5px;" ><i class="glyphicon glyphicon-pencil"></i></a>
										 <a href="<?=common::get_component_link(array('user','delete')).'&id='.$d['id']; ?>" class="" style="float: left; padding: 5px;"  title="Apagar"><i class="glyphicon glyphicon-remove"></i></a> 
