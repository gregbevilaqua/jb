...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><i class="fa fa-dashboard"></i> Painel de Controle</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
   ...
   <input class="btn btn-primary btn-lg col-md-12 " type="submit" name="add" value="Add" />
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <i class="glyphicon glyphicon-user"></i> Empresas Pendentes
                                            </div>
                                            <!-- /.panel-heading -->
                                            <div class="panel-body">
                                ...
                                foreach($usersdata as $d)
                                {
                                    ...
                                    <tr class="odd gradeX">
                                            ...
                                            <td class="center"><a href="<?=common::get_component_link(array("company","delete"))."&id=".$d["id"]; ?>" title="Apagar"><i class="glyphicon glyphicon-remove-circle"></i></a>
                                            <a href="<?=common::get_component_link(array("company","edit"))."&id=".$d["id"]; ?>" title="Editar"><i class="fa fa-edit"></i></a></td>
