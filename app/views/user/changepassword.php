...
<div class="row">
<div class="col-lg-12">
<h1 class="page-header"><i class="fa fa-lock fa-fw"></i> Alterar Senha</h1>
</div>
</div>
<div class="row">
    <div class="col-md-6">
...
<div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-lock fa-fw"></i> Alterar senha
                        </div>
                        <!-- /.panel-heading -->
        ...
        <? if ( common::do_show_message() ) {
			...
			<form id="form" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Senha atual</label>
                        <div class="col-lg-8">
						<input class="form-control" name="password" type="password" />
					</div>
                    </div>
                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Nova Senha</label>
                        <div class="col-lg-8">
                    ...
                    <div class="form-group">
                        <div class="col-lg-8">
						<input class="btn" type="submit" name="set" value="Alterar Senha" />
					       </div>
                    </div>
                    </div>
            </form>
