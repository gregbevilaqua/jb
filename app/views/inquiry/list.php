...
<div class="row">
<div class="col-lg-12">
<h1 class="page-header"><i class="fa fa-envelope fa-fw"></i>Mensagens</h1>
</div>
</div>
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-envelope fa-fw"></i> Listar mensagens
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <? foreach($data as $d){ ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <?="Estado : ".$d["state"]; ?></td>
                                            <td><?=$d["company"]; ?></td>
                                            <td><?="Assunto : ".$d["subject"]."<br /><br />".$d["message"]; ?></td>
                                            <td><?=$d["date"]; ?></td>
                                        </tr>
                                     <? } ?>   
                                    </tbody>
