<?php
	class form_validation
	{
		...
		public static $template_error_message = array (
														0 => '<li>&ndash; Favor digitar ##field_name##.</li>'
														,1 => '<li>&ndash; Favor selecionar an option in ##field_name##.</li>'
														...
														,9 => '<li>&ndash; Por favor, informe um e-mail válido ##field_name##.</li>'
