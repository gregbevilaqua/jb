				...
				public static function show_message ( $entity = '' ) {
					...
					switch ( intval($message_input[0])  ) {
						...
						case 3:
							...
							$strmessage_title = 'Atualização ' . $entity;

							$strmessage_sentence = $entity . ' dados atualizados com sucesso.';	
						...
						case 6:
							...
							$strmessage_title = 'Bem-vindo';

							$strmessage_sentence = 'Você está conectado.';	
						...
						case 8:
							...
							$strmessage_title = 'Alterar Senha';

							$strmessage_sentence = 'A senha não foi encontrado. Por favor, tente novamente..';	
						...
						case 9:
							...
							$strmessage_sentence = 'A senha foi alterada com sucesso.';	
						...
						case 11:
							...
							$strmessage_sentence = 'Por favor, selecione pelo menos um registro que você deseja excluir. ';	
