...
$companyname = common::get_control_value("companyname");

           
            
            $q=new Query();
            $q->insert_into("enquries",array("name"=>$name,"company_id"=>$company,"email"=>$email,"phone"=>$phone,"city"=>$city,"message"=>$message,"subject"=>$subject,"company"=>$companyname,"date"=>date('Y-m-d H:i:s')))
            ->run();
