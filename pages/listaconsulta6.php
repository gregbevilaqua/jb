...
$query = mysql_query("SELECT * FROM devedor WHERE data >='$data' AND data <= '$dataf' ORDER BY data ASC");
?>
<!DOCTYPE HTML>
<html>
<head>
...
$query = "SELECT * FROM devedor WHERE operador ='".$operador."' AND data >='$data' AND data <= '$dataf'  ORDER BY data DESC";
...
?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><?php echo "<h1>Pontos Negativos</h1>";
...
while($row = mysql_fetch_array($result)) {
	echo "<tr>
        ...
        <td>".$row[4]."</td>
        <td>".$row[5]."</td>
        <td><a href='deletedevedor.php?id=".$row[0]."'><img src='images/delete.png'></a></td>
        </tr>";
} 
?>
          </tbody>
...
<?php
require_once("includes/db2.php");
$query_valor = "SELECT SUM(devedor)as SOMA FROM devedor WHERE operador ='".$operador."' AND data >='$data' AND data <= '$dataf' ORDER BY data DESC";
