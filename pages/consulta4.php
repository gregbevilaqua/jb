...
echo "<center>";
echo "<h1>Consulta de Pagamentos Online</h1>";
echo "<h1>Por Data</h1>";
echo "<h3>Operador: ".$operador."</h3>";
$query = "SELECT DISTINCT ponto FROM pagamento WHERE operador ='".$operador."'";
...
<body>
<form name="form1" method="post" action="index.php?page=listaconsult4&operador=<?php echo $operador; ?>">
Nome do Ponto:
        <select name="ponto">
          <?php echo $options;?>
        </select>
