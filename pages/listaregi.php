...
echo "<h3>Gerentes Cadastrados:</h3>";
                    echo "<h3>Gerentes</h3>";?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
...
<body>
 ...
 <div class="table-responsive">
        ...
        <tbody>
<?
$result = mysql_query("SELECT * FROM regiao");
while($row = mysql_fetch_array($result)) {
    	echo "<tr>
        <td>".$row[1]."</td>
        <td>".$row[2]."</td>
        <td><a href='index.php?page=delregi&user=".$row[1]."'><img src='images/delete.png'></a></td>
        </tr>";
