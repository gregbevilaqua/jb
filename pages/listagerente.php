...
$query = "SELECT * FROM milhar WHERE gerente ='".$ponto."' AND data >='$data' AND data <= '$dataf' ORDER BY data DESC";
$result = mysql_query($query) or die(mysql_error());

$query3 = "SELECT * FROM centena WHERE gerente ='".$ponto."' AND data >='$data' AND data <= '$dataf' ORDER BY data DESC";
$result3 = mysql_query($query3) or die(mysql_error());

$query4 = "SELECT * FROM dezena WHERE gerente ='".$ponto."' AND data >='$data' AND data <= '$dataf' ORDER BY data DESC";
$result4 = mysql_query($query4) or die(mysql_error());

$query5 = "SELECT * FROM grupo WHERE gerente ='".$ponto."' AND data >='$data' AND data <= '$dataf' ORDER BY data DESC";
$result5 = mysql_query($query5) or die(mysql_error());

$query6 = "SELECT * FROM centenain WHERE gerente ='".$ponto."' AND data >='$data' AND data <= '$dataf' ORDER BY data DESC";
$result6 = mysql_query($query6) or die(mysql_error());

$query8 = "SELECT * FROM duquedeze WHERE gerente ='".$ponto."' AND data >='$data' AND data <= '$dataf' ORDER BY data DESC";
$result8 = mysql_query($query8) or die(mysql_error());

$query9 = "SELECT * FROM duquegp WHERE gerente ='".$ponto."' AND data >='$data' AND data <= '$dataf' ORDER BY data DESC";
$result9 = mysql_query($query9) or die(mysql_error());

$query10 = "SELECT * FROM mc WHERE gerente ='".$ponto."' AND data >='$data' AND data <= '$dataf' ORDER BY data DESC";
$result10 = mysql_query($query10) or die(mysql_error());

$query11 = "SELECT * FROM milharin WHERE gerente ='".$ponto."' AND data >='$data' AND data <= '$dataf' ORDER BY data DESC";
$result11 = mysql_query($query11) or die(mysql_error());

$query12 = "SELECT * FROM passevai WHERE gerente ='".$ponto."' AND data >='$data' AND data <= '$dataf' ORDER BY data DESC";
$result12 = mysql_query($query12) or die(mysql_error());

$query13 = "SELECT * FROM ternode WHERE gerente ='".$ponto."' AND data >='$data' AND data <= '$dataf' ORDER BY data DESC";
$result13 = mysql_query($query13) or die(mysql_error());

$query14 = "SELECT * FROM ternogp WHERE gerente ='".$ponto."' AND data >='$data' AND data <= '$dataf' ORDER BY data DESC";
