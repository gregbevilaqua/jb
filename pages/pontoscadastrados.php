...
$query = "SELECT * FROM maquina WHERE operador ='".$operador."' ORDER BY ponto DESC";
...
?>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><?php echo "<h1>Pontos</h1>";
...
while($row = mysql_fetch_array($result)) {
	echo "<tr>
        ...
        <td>".$row[7]."</td>
        <td>".$row[8]."</td>
        <td><a href='editmaquinas.php?id=".$row[0]."'><img src='images/edit.png'></a></td>
        <td><a href='deletecadastrado.php?id=".$row[0]."'><img src='images/delete.png'></a></td>
        </tr>";
