...
//
$_CONFIG['main_title'] = "Backup Operadores Jre77";
...
$_TRANSLATIONS["cz"] = array(
	"file_name" => "NÃ¡zev souboru",
	"size" => "Velikost",
	"last_changed" => "ZmÄ›nÄ›no",
	"total_used_space" => "ObsazenÃ½ prostor",
	"free_space" => "VolnÃ½ prostor",
	"password" => "Heslo",
	"upload" => "NahrÃ¡t",
	"failed_upload" => "NahrÃ¡vÃ¡nÃ­ se nezdaÅ™ilo!",
	"failed_move" => "PÅ™esun souboru do urÄenÃ©ho adresÃ¡Å™e se nezdaÅ™il!",
	"wrong_password" => "ChybnÃ© heslo",
	"make_directory" => "NovÃ½ adresÃ¡Å™",
	"new_dir_failed" => "VytvoÅ™enÃ­ adresÃ¡Å™e se nezdaÅ™ilo",
	"chmod_dir_failed" => "ZmÄ›na prÃ¡v adresÃ¡Å™e se nezdaÅ™ila",
	"unable_to_read_dir" => "Chyba pÅ™i ÄtenÃ­ adresÃ¡Å™e",
	"location" => "UmÃ­stÄ›nÃ­",
	"root" => "KoÅ™enovÃ½ adresÃ¡Å™",
	"log_file_permission_error" => "Skript nemÃ¡ oprÃ¡vnÄ›nÃ­ k zÃ¡pisu do souboru protokolu.",
	"upload_not_allowed" => "KonfiguraÄnÃ­ skript neumoÅ¾Åˆuje nahrÃ¡vÃ¡nÃ­ v tomto adresÃ¡Å™i.",
	"upload_dir_not_writable" => "Tento adresÃ¡Å™ nemÃ¡ oprÃ¡vnÄ›nÃ­ k zÃ¡pisu.",
	"mobile_version" => "ZobrazenÃ­ pro mobil",
	"standard_version" => "StandardnÃ­ zobrazenÃ­",
	"page_load_time" => "StrÃ¡nka nahrÃ¡na za %.2f ms",
	"wrong_pass" => "Å patnÃ© uÅ¾ivatelskÃ© jmÃ©no nebo heslo",
	"username" => "UÅ¾ivatelskÃ© jmÃ©no",
	"log_in" => "PÅ™ihlÃ¡sit se",
	"upload_type_not_allowed" => "Tento typ souboru nenÃ­ povolen pro nahrÃ¡vÃ¡nÃ­.",
	"del" => "Smazat",
	"log_out" => "OdhlÃ¡sit se"
);
...
$_TRANSLATIONS["fr"] = array(
	...
	"size" => "Taille",
	"last_changed" => "AjoutÃ©",
	"total_used_space" => "Espace total utilisÃ©",
	...
	"new_dir_failed" => "Erreur lors de la crÃ©ation du dossier",
	"chmod_dir_failed" => "Impossible de changer les permissions du dossier",
	"unable_to_read_dir" => "Impossible de lire le dossier",
	"location" => "Localisation",
	"root" => "Racine",
	"log_file_permission_error" => "Le script ne possÃ¨de pas les permissions pour Ã©crire un fichier d'enregistrement.",
	"upload_not_allowed" => "La configuration actuelle ne permet de dÃ©poser un fichier dans ce dossier.",
	"upload_dir_not_writable" => "Ce dossier ne possÃ¨de pas les permissions en Ã©criture.",
	"mobile_version" => "Vue mobile",
	"standard_version" => "Vue standard",
	"page_load_time" => "Page chargÃ©e en %.2f ms",
	"wrong_pass" => "Identifiant ou mot de passe incorrect",
	"username" => "Identifiant",
	"log_in" => "Connexion",
	"upload_type_not_allowed" => "Ce format de fichier n'est pas autorisÃ©.",
	"del" => "Effacer",
...
$_TRANSLATIONS["it"] = array(
	...
	"username" => "Username",
	"log_in" => "Log in",
	"upload_type_not_allowed" => "Questo formato di file non Ã¨ abilitato per l'upload.",
...
$_TRANSLATIONS["pt_PT"] = array(
	...
	"chmod_dir_failed" => "Falha ao mudar os privilÃ©gios da pasta",
	"unable_to_read_dir" => "NÃ£o foi possÃ­vel ler a pasta",
	"location" => "LocalizaÃ§Ã£o",
	"root" => "RaÃ­z",
	"log_file_permission_error" => "O script nÃ£o tem permissÃ£o para escrever o ficheiro de log.",
	"upload_not_allowed" => "A configuraÃ§Ã£o do script nÃ£o permite envios para esta pasta.",
	"upload_dir_not_writable" => "NÃ£o hÃ¡ permissÃ£o para escrita nesta pasta.",
	"mobile_version" => "VersÃ£o MÃ³vel",
	"standard_version" => "VersÃ£o PadrÃ£o",
	"page_load_time" => "PÃ¡gina carregada em %.2f ms",
	...
	"log_in" => "Entrar",
	"upload_type_not_allowed" => "NÃ£o Ã© permitido o envio de ficheiros deste tipo.",
	"del" => "Apagar",
	"log_out" => "Sair"
);
...
$_TRANSLATIONS["sk"] = array(
	...
	"free_space" => "VoÄ¾nÃ© miesto",
	"password" => "Heslo",
	"upload" => "Nahranie sÃºborov",
	"failed_upload" => "Chyba nahrÃ¡vania sÃºboru!",
	"failed_move" => "Nepodarilo sa presunÃºÅ¥ sÃºbor do vybranÃ©ho adresÃ¡ra!",
	"wrong_password" => "NeplatnÃ© heslo!",
	"make_directory" => "NovÃ½ prieÄinok",
	"new_dir_failed" => "Nepodarilo sa vytvoriÅ¥ adresÃ¡r!",
	"chmod_dir_failed" => "Nepodarilo sa zmeniÅ¥ prÃ¡va adresÃ¡ra!",
	"unable_to_read_dir" => "NemÃ´Å¾em ÄÃ­taÅ¥ adresÃ¡r",
...
$_TRANSLATIONS["eo"] = array(
	...
	"upload_not_allowed" => "La skripto malpermesas alÅuti en Ä‰i tiun dosierujon.",
	"upload_dir_not_writable" => "Äˆi tiu dosierujo ne rajtigas skribadon.",
	"mobile_version" => "Vido por mobilaj iloj",
	"standard_version" => "DefaÅ­lta vido",
	"page_load_time" => "PaÄo ÅarÄita en %.2f ms",
	"wrong_pass" => "MalÄusta salutnomo aÅ­ pasvorto",
	"username" => "Salutnomo",
	"log_in" => "Ensaluto",
	"upload_type_not_allowed" => "AlÅuto estas malpermesita por Ä‰i tiu dosiertipo.",
